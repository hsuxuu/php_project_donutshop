...
* 圖片部分
1. 全採用電繪，在美術方面想要保有自己的風格與原創性
2. 使用Photoshop編輯圖片及繪畫
3. 為了保存較好的圖片畫質，圖檔皆為 **.png** 因此檔案偏大，主要是背景會超過作業上傳限制
...
2. 主要著重在
    - 使用者登入登出系統（acc_*.php）
    - 留言版功能新增刪修（kingdom_modify.php、kingdom_note.php、kingdom_remove.php）
    - 選擇薑餅人角色（cookieStory.php）
3. 使用到資料庫db.sql
---
#### kingdom_index.php 
